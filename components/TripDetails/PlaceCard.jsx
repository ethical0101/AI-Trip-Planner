    ...
    <View style={{
      ...
      {photoRef ? (
        ...
        <View style={{
          ...
          <Text style={{ fontFamily: 'outfit-medium', fontSize: 17 }}>No Image</Text>
        </View>
      )}
      <View style={{
        marginTop: 5,
        ...
        <Text style={{ fontSize: 14, fontFamily: 'outfit-medium', color: '#7C7C7C' }}>
        ...
        <View style={{
          ...
          <View style={{ flex: 1 }}>
            <Text style={{
              ...
              🎟️Ticket Price: <Text style={{ fontFamily: 'outfit-bold' }}>{activity.ticketPricing}</Text>
            </Text>
            <Text style={{
              fontFamily: 'outfit',
              marginTop: 5,
              ...
              ⏱️Time To Travel: <Text style={{ fontFamily: 'outfit-bold' }}>{activity.duration}</Text>
            </Text>
          </View>
          <TouchableOpacity
            style={{
