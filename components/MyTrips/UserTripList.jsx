...
export default function UserTripList({ userTrips }) {
  ...
  const sortedTrips = userTrips.sort((a, b) => new Date(a.tripData.startDate) - new Date(b.tripData.startDate));
  ...
  const selectedTripData = selectedTrip ? JSON.parse(selectedTrip.tripData) : null;
      ...
      <View style={{ marginTop: 20 }}>
        ...
        <View style={{ marginTop: 10 }}>
          ...
          >
            ...
            >
              {selectedTripData ? moment(selectedTripData.startDate).format('DD MMM yyyy') : ''}
            </Text>
            <Text
              style={{
                fontFamily: 'outfit',
